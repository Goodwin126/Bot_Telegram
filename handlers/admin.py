...
async def make_changes_command(message: types.Message):
    ...
    await bot.send_message(message.from_user.id, 'Что хозяин надо???', reply_markup=admin_kb.buttonc_case_admin)
...
#ловим второй ответ
@dp.message_handler(state=FMSAdmin.name)
...
@dp.message_handler(state=FMSAdmin.price)
